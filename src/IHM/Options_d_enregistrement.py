...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.CB_Enregistrement_copies = QtWidgets.QCheckBox(Dialog)
        ...
        self.CB_Enregistrement_copies.setObjectName("CB_Enregistrement_copies")
        ...
        spacerItem2 = QtWidgets.QSpacerItem(15, 15, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_2.addItem(spacerItem2)
        self.CB_Envoi_copies_fichiers_par_mail = QtWidgets.QCheckBox(Dialog)
        ...
        self.CB_Envoi_copies_fichiers_par_mail.setObjectName("CB_Envoi_copies_fichiers_par_mail")
        ...
        self.B_Valider_options = QtWidgets.QPushButton(Dialog)
        ...
        self.B_Valider_options.setStyleSheet("background-color: qlineargradient(spread:repeat, x1:1, y1:1, x2:1, y2:0, stop:0.5 rgba(70, 70, 70, 255), stop:1 rgba(200, 200, 200, 255));\n"
"color: rgb(240, 240, 240);")
        self.B_Valider_options.setObjectName("B_Valider_options")
