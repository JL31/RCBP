...
class ActionsAvantDeQuitterLApplication(object):
    """
        Classe qui définit les actions réalisées avant de quitter l'application
    """
    ...
    def mise_a_jour_d_un_fichier_de_donnees(self, element):
        ...
        self._dico_des_parametres[element]["donnees"].to_csv(
    ...
    def execution_des_actions(self):
        ...
        # Etape 2 - Enregistrement d'une copie des fichiers des comptes et de la balance dans un autre répertoire et
        # sous un autre nom
